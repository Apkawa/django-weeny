...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'URLTracking.target_url'
        db.alter_column(u'weeny_urltracking', 'target_url', self.gf('django.db.models.fields.CharField')(max_length=4096))

        # Changing field 'URLTracking.weeny_url'
        db.alter_column(u'weeny_urltracking', 'weeny_url', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'URLTracking.target_url'
        db.alter_column(u'weeny_urltracking', 'target_url', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'URLTracking.weeny_url'
        db.alter_column(u'weeny_urltracking', 'weeny_url', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'weeny.urltracking': {
            ...
            'target_url': ('django.db.models.fields.CharField', [], {'max_length': '4096'}),
            ...
            'weeny_url': ('django.db.models.fields.CharField', [], {'max_length': '1024'})
        },
        u'weeny.useragent': {
