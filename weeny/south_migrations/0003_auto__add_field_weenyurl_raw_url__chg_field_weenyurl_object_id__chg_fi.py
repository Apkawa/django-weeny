...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeenyURL.raw_url'
        db.add_column(u'weeny_weenyurl', 'raw_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'WeenyURL.object_id'
        db.alter_column(u'weeny_weenyurl', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'WeenyURL.content_type'
        db.alter_column(u'weeny_weenyurl', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['contenttypes.ContentType']))

    def backwards(self, orm):
        # Deleting field 'WeenyURL.raw_url'
        db.delete_column(u'weeny_weenyurl', 'raw_url')


        # User chose to not deal with backwards NULL issues for 'WeenyURL.object_id'
        raise RuntimeError("Cannot reverse this migration. 'WeenyURL.object_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WeenyURL.object_id'
        db.alter_column(u'weeny_weenyurl', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'WeenyURL.content_type'
        raise RuntimeError("Cannot reverse this migration. 'WeenyURL.content_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WeenyURL.content_type'
        db.alter_column(u'weeny_weenyurl', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        u'weeny.weenyurl': {
            ...
            'raw_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'track': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
